...
public class Solution
{
    public static void main(String[] args)
    {
        ...
        childrens.add(new Human("Kid1",true,5,new ArrayList<Human>()));
        childrens.add(new Human("Kid2",false,10,new ArrayList<Human>()));
        childrens.add(new Human("Kid3",true,1,new ArrayList<Human>()));
