...
1) создайте список, котторый сможет хранить призрачные
 ссылки на объекты Monkey
2) добавьте в список 200 ссылок, используйте
 очередь helper.getQueue()
...
public class Solution {
    ...
    public static class Monkey {
        public Monkey(int i) // удалить конструктор
        {
