...
/* Читаем и пишем в файл Human Реализуйте логику записи в файл и чтения из файла для класса Human
    ...
    public static class Human
    {
        ...
        public void save(OutputStream outputStream) throws Exception
        {
            ...
            if ("yes".equals(hasName))
            {
                ...
                {
                    for (Asset curett : this.assets)
                        printWriter.println(curett.getName());
                }
            }
            printWriter.close();
