...
/* Читаем и пишем в файл: JavaRush Реализуйте логику записи в файл и чтения из файла для класса JavaRush
...
public class Solution
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            File your_file_name = File.createTempFile("my_file", null);
    ...
    public static class JavaRush
    {
        ...
        public void load(InputStream inputStream) throws IOException, ParseException, ParseException
        {
