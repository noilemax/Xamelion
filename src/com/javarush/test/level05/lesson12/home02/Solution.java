...
public class Solution
{
    ...
    {
        Man man1 = new Man("Vasya", 12, "daleko");                                //создай по два объекта каждого класса тут
        Man man2 = new Man("Igor", 33, "Tam_ge");


        Woman woman1 = new Woman("Ira", 18, "na obezdnoi");
        Woman woman2 = new Woman("Vera", 21, "strip bar");
