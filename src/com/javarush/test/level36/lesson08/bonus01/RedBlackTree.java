...
public class RedBlackTree
{
    ...
    private Node rotate(int item, Node parent)
    {
        if (item < parent.element)
            ...
            return parent.left = item < parent.left.element ? rotateWithLeftNode(parent.left) : rotateWithRightNode(parent.left);
        else
            return parent.right = item < parent.right.element ? rotateWithLeftNode(parent.right) : rotateWithRightNode(parent.right);
    }

    private Node rotateWithLeftNode(Node element)
    {
        Node k1 = element.left;
        element.left = k1.right;
        k1.right = element;
        return k1;
    }
    ...
    {
        Node k2 = element.right;
        element.right = k2.left;
        k2.left = element;
        return k2;
    }
