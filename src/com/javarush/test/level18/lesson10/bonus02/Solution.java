    ...
    public static void main(String[] args) throws Exception
    {
        ...
        if (args[0].equals("-c"))
        {
            while (file.ready())
            {
                ...
                list.add(str);
                int y = Integer.parseInt(str.substring(0, 8).replace(" ", ""));//выбираем последнюю строчку с введенным товаром и берем от туда айди
                if (y > max) max = y;//нафига?
            }
            max++;//прибавляем к айди 1
            file.close();
